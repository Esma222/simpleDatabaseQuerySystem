...
def infoDel(choiceInp, sorted_data):#input length must be 7 or 11
    if len(choiceInp)==11 and (choiceInp[7]=='AND' or choiceInp[7]=='and') :# if input length is correct and "and" is used
        ...
        return sorted_data
    elif len(choiceInp)==11 and (choiceInp[7]=='OR' or choiceInp[7]=='or') :# if input length is correct and "or" is used
        k=4
...
def write_Jason(sorted_data):
    with open('students6.json', 'w') as json_file:
